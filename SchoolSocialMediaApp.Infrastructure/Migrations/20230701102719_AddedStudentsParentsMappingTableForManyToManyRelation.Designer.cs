...
namespace SchoolSocialMediaApp.Infrastructure.Migrations
{
    ...
    [Migration("20230701102719_AddedStudentsParentsMappingTableForManyToManyRelation")]
    partial class AddedStudentsParentsMappingTableForManyToManyRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolSocialMediaApp.Infrastructure.Data.Models.StudentsParents", b =>
                {
                    b.Property<Guid>("StudentId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("The id of the student.");
                    ...
                    b.HasComment("Parents to students mapping table");
                });
            ...
            modelBuilder.Entity("SchoolSocialMediaApp.Infrastructure.Data.Models.Parent", b =>
                {
                    ...
                    b.HasOne("SchoolSocialMediaApp.Infrastructure.Data.Models.Student", null)
                        .WithMany("Parents")
            ...
            modelBuilder.Entity("SchoolSocialMediaApp.Infrastructure.Data.Models.Principal", b =>
                {
                    b.HasOne("SchoolSocialMediaApp.Infrastructure.Data.Models.School", "School")
                        .WithOne("Principal")
                        .HasForeignKey("SchoolSocialMediaApp.Infrastructure.Data.Models.Principal", "SchoolId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("SchoolSocialMediaApp.Infrastructure.Data.Models.StudentsParents", b =>
                {
                    ...
                    b.HasOne("SchoolSocialMediaApp.Infrastructure.Data.Models.Student", "Student")
                        .WithMany()
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
